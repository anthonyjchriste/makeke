...
public class RequestPage extends FluentPage {
  private String url;

  public RequestPage(WebDriver webDriver, int port) {
    super(webDriver);
    this.url = "http://localhost:" + port + "/manage";
  }
  ...
  public void isAt() {
    assert (title().equals("My Requests / Offers"));
  }
}
